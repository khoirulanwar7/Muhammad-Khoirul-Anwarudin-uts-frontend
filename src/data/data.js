...
const heroapi = {
  title: "Aktifitas Bersama Electric Nike",
  subtitle: "Adapt 2.0 Sneakers",
  img: heroimg,
  btntext: "Lihat Product",
  videos: [
...
const footerAPI = {
  ...
  links: [
    ...
    [{ link: "Order Status" }, { link: "Shipping & Delivery" }, { link: "Payment Options" }, { link: "Gift Card Balance" }, { link: "Contact Us" }, { link: "FAQ" }, { link: "Blog" }],
